...
DEFINE_CLK_DIVIDER(dpll_abe_m2x2_ck, "dpll_abe_x2_ck", &dpll_abe_x2_ck,
		   0x0, OMAP4430_CM_DIV_M2_DPLL_ABE,
		   OMAP4430_DPLL_CLKOUT_DIV_SHIFT,
		   OMAP4430_DPLL_CLKOUT_DIV_WIDTH, CLK_DIVIDER_ONE_BASED,
		   NULL);
...
DEFINE_CLK_DIVIDER(dpll_abe_m3x2_ck, "dpll_abe_x2_ck", &dpll_abe_x2_ck, 0x0,
...
DEFINE_CLK_DIVIDER(dpll_core_m6x2_ck, "dpll_core_x2_ck", &dpll_core_x2_ck, 0x0,
		   OMAP4430_CM_DIV_M6_DPLL_CORE,
		   OMAP4430_HSDIVIDER_CLKOUT3_DIV_SHIFT,
		   OMAP4430_HSDIVIDER_CLKOUT3_DIV_WIDTH,
		   CLK_DIVIDER_ONE_BASED, NULL);

DEFINE_CLK_DIVIDER(dpll_core_m2_ck, "dpll_core_ck", &dpll_core_ck, 0x0,
		   OMAP4430_CM_DIV_M2_DPLL_CORE, OMAP4430_DPLL_CLKOUT_DIV_SHIFT,
...
DEFINE_CLK_DIVIDER(dpll_core_m5x2_ck, "dpll_core_x2_ck", &dpll_core_x2_ck, 0x0,
...
DEFINE_CLK_DIVIDER(div_iva_hs_clk, "dpll_core_m5x2_ck", &dpll_core_m5x2_ck, 0x0,
		   OMAP4430_CM_BYPCLK_DPLL_IVA, OMAP4430_CLKSEL_0_1_SHIFT,
		   OMAP4430_CLKSEL_0_1_WIDTH, CLK_DIVIDER_POWER_OF_TWO,
		   NULL);
...
DEFINE_CLK_DIVIDER(dpll_core_m4x2_ck, "dpll_core_x2_ck", &dpll_core_x2_ck, 0x0,
...
DEFINE_CLK_DIVIDER(dpll_core_m3x2_ck, "dpll_core_x2_ck", &dpll_core_x2_ck, 0x0,
		   OMAP4430_CM_DIV_M3_DPLL_CORE,
		   OMAP4430_DPLL_CLKOUTHIF_DIV_SHIFT,
		   OMAP4430_DPLL_CLKOUTHIF_DIV_WIDTH, CLK_DIVIDER_ONE_BASED,
		   NULL);

DEFINE_CLK_DIVIDER(dpll_core_m7x2_ck, "dpll_core_x2_ck", &dpll_core_x2_ck, 0x0,
...
DEFINE_CLK_DIVIDER(dpll_iva_m4x2_ck, "dpll_iva_x2_ck", &dpll_iva_x2_ck, 0x0,
		   OMAP4430_CM_DIV_M4_DPLL_IVA,
		   OMAP4430_HSDIVIDER_CLKOUT1_DIV_SHIFT,
		   OMAP4430_HSDIVIDER_CLKOUT1_DIV_WIDTH, CLK_DIVIDER_ONE_BASED,
		   NULL);

DEFINE_CLK_DIVIDER(dpll_iva_m5x2_ck, "dpll_iva_x2_ck", &dpll_iva_x2_ck, 0x0,
...
DEFINE_CLK_DIVIDER(dpll_mpu_m2_ck, "dpll_mpu_ck", &dpll_mpu_ck, 0x0,
		   OMAP4430_CM_DIV_M2_DPLL_MPU, OMAP4430_DPLL_CLKOUT_DIV_SHIFT,
		   OMAP4430_DPLL_CLKOUT_DIV_WIDTH, CLK_DIVIDER_ONE_BASED, NULL);
...
DEFINE_CLK_DIVIDER(dpll_per_m2x2_ck, "dpll_per_x2_ck", &dpll_per_x2_ck, 0x0,
		   OMAP4430_CM_DIV_M2_DPLL_PER, OMAP4430_DPLL_CLKOUT_DIV_SHIFT,
		   OMAP4430_DPLL_CLKOUT_DIV_WIDTH, CLK_DIVIDER_ONE_BASED, NULL);

DEFINE_CLK_DIVIDER(dpll_per_m3x2_ck, "dpll_per_x2_ck", &dpll_per_x2_ck, 0x0,
		   OMAP4430_CM_DIV_M3_DPLL_PER,
		   OMAP4430_DPLL_CLKOUTHIF_DIV_SHIFT,
		   OMAP4430_DPLL_CLKOUTHIF_DIV_WIDTH, CLK_DIVIDER_ONE_BASED,
		   NULL);

DEFINE_CLK_DIVIDER(dpll_per_m4x2_ck, "dpll_per_x2_ck", &dpll_per_x2_ck, 0x0,
		   OMAP4430_CM_DIV_M4_DPLL_PER,
		   OMAP4430_HSDIVIDER_CLKOUT1_DIV_SHIFT,
		   OMAP4430_HSDIVIDER_CLKOUT1_DIV_WIDTH,
		   CLK_DIVIDER_ONE_BASED, NULL);

DEFINE_CLK_DIVIDER(dpll_per_m5x2_ck, "dpll_per_x2_ck", &dpll_per_x2_ck, 0x0,
		   OMAP4430_CM_DIV_M5_DPLL_PER,
		   OMAP4430_HSDIVIDER_CLKOUT2_DIV_SHIFT,
		   OMAP4430_HSDIVIDER_CLKOUT2_DIV_WIDTH,
		   CLK_DIVIDER_ONE_BASED, NULL);

DEFINE_CLK_DIVIDER(dpll_per_m6x2_ck, "dpll_per_x2_ck", &dpll_per_x2_ck, 0x0,
		   OMAP4430_CM_DIV_M6_DPLL_PER,
		   OMAP4430_HSDIVIDER_CLKOUT3_DIV_SHIFT,
		   OMAP4430_HSDIVIDER_CLKOUT3_DIV_WIDTH,
		   CLK_DIVIDER_ONE_BASED, NULL);

DEFINE_CLK_DIVIDER(dpll_per_m7x2_ck, "dpll_per_x2_ck", &dpll_per_x2_ck, 0x0,
		   OMAP4430_CM_DIV_M7_DPLL_PER,
		   OMAP4430_HSDIVIDER_CLKOUT4_DIV_SHIFT,
		   OMAP4430_HSDIVIDER_CLKOUT4_DIV_WIDTH, CLK_DIVIDER_ONE_BASED,
		   NULL);
...
DEFINE_CLK_DIVIDER(dpll_usb_m2_ck, "dpll_usb_ck", &dpll_usb_ck, 0x0,
...
DEFINE_STRUCT_CLK(timer10_fck, abe_dpll_bypass_clk_mux_ck_parents,
		  dmic_fck_ops);
...
DEFINE_STRUCT_CLK(timer11_fck, abe_dpll_bypass_clk_mux_ck_parents,
		  dmic_fck_ops);
...
DEFINE_CLK_DIVIDER(trace_clk_div_ck, "pmd_trace_clk_mux_ck",
